...
#include "custom_msgs/msg/detail/movement__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::Movement & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::Movement & ros_message)
{
  // Member: velocity
  cdr >> ros_message.velocity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::Movement;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::Movement *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::Movement *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Movement__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, Movement)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_Movement__handle;
}
