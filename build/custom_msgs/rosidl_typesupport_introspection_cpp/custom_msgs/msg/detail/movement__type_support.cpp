...
{
  new (message_memory) custom_msgs::msg::Movement(_init);
}

void Movement_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::Movement *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Movement_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs::msg::Movement, velocity),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::Movement, acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Movement_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_msgs::msg::Movement),
...
get_message_type_support_handle<custom_msgs::msg::Movement>()
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Movement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, Movement)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Movement_message_type_support_handle;
}
