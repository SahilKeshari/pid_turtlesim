...
bool custom_msgs__msg__movement__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._movement.Movement", full_classname_dest, 34) == 0);
  }
  custom_msgs__msg__Movement * ros_message = _ros_message;
  {  // velocity
...
PyObject * custom_msgs__msg__movement__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._movement");
